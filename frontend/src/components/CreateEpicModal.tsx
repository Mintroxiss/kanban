...
const inputCls = 'bg-white/[0.08] border border-white/[0.14] rounded-2xl px-4 py-2.5 text-sm text-white/90 placeholder:text-white/30 focus:outline-none focus:border-violet-400/50 focus:bg-white/[0.11] transition-all'
